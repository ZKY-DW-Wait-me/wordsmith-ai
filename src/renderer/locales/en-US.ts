...
export const enUS: LocaleResource = {
  ...
  latex: {
    ...
    copyLatexDesc: 'Paste into WPS equation editor, press Ctrl+= to build',
    mathTargetLabel: 'Target',
  ...
  typography: {
    title: 'Typography',
    cnFont: 'CJK Font',
    westernFont: 'Latin Font',
    fontSize: 'Size',
    letterSpacing: 'Letter Spacing',
    lineHeight: 'Line Spacing',
    lineHeightTimes: 'Line Spacing (×)',
    lineHeightMultiple: 'Multiple',
    lineHeightFixed: 'Fixed',
