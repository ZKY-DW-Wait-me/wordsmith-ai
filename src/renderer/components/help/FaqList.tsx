    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <details className="group rounded-lg border border-slate-200 open:bg-slate-50">
          <summary className="cursor-pointer p-4 font-medium select-none group-open:text-blue-600">
            Q: 为什么生成的公式在 Word 里是乱码？
          </summary>
          <div className="border-t border-slate-200 p-4 pt-2 text-sm text-slate-600">
